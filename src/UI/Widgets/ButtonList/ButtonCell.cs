...
public class ButtonCell : ICell
{
    ...
    public virtual GameObject CreateContent(GameObject parent)
    {
        ...
        Button = UIFactory.CreateTMPButton(UIRoot, "NameButton", "Name");
        UIFactory.SetLayoutElement(Button.Component.gameObject, flexibleWidth: 9999, minHeight: 25, flexibleHeight: 0);
        Button.ButtonTMPText.overflowMode = TextOverflowModes.Overflow;
        Button.ButtonTMPText.alignment = TextAlignmentOptions.Left;
