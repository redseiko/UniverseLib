...
public static class UniversalUI
{
    ...
    /// <summary>The Console TextMeshPro font asset.</summary>
    public static TMP_FontAsset ConsoleTMPFont { get; private set; }

    /// <summary>The default font asset.</summary>
    public static Font DefaultFont { get; private set; }

    /// <summary>The default TextMeshPro font asset.</summary>
    ...
    private static void LoadBundle()
    {
        ...
        ConsoleTMPFont = TMP_FontAsset.CreateFontAsset(ConsoleFont);
        ConsoleTMPFont.name = $"Consola-TMP";
        ConsoleTMPFont.hideFlags = HideFlags.HideAndDontSave;
        UnityEngine.Object.DontDestroyOnLoad(ConsoleTMPFont);
