...
public static class ToStringUtility
{
    ...
    private const string nullString = "<color=#808080FF>null</color>";
    private const string nullUnknown = nullString + " (?)";
    private const string destroyedString = "<color=#FF0000FF>Destroyed</color>";
    private const string untitledString = "<i><color=#808080FF>untitled</color></i>";
